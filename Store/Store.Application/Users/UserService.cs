...
public class UserService : IUserService
{
    ...
    public async Task<UserResult> LoginAsync(AuthenticateUserDtoApp userForAuthentication)
    {
    ...
    public async Task<UserResult> RegisterUserAsync(RegisterUserDtoApp userForRegistration)
    {
    ...
    public async Task<UserResult> ConfirmEmailAsync(string userId, string token)
    {
    ...
    public async Task<UserResult> RequestDeletionAsync()
    {
    ...
    public async Task<UserResult> SubmitDeletionAsync(string userId)
    {
        StoreUser user = await _userManager.FindByIdAsync(userId);
